...
public class FlicButtonPlugin implements FlutterPlugin, MethodCallHandler {
  ...
  public static final int METHOD_FLIC2_SCANNING = 103;
  public static final int METHOD_FLIC2_SCAN_COMPLETE = 104;
  public static final int METHOD_FLIC2_FOUND = 105;
  public static final int METHOD_FLIC2_ERROR = 200;
  public static final int METHOD_FLIC2_BUTTON_CLICK_SINGLE_OR_DOUBLE_CLICK_OR_HOLD = 301;
  public static final int METHOD_FLIC2_BUTTON_UP_OR_DOWN = 302;
  public static final int METHOD_FLIC2_BUTTON_CLICK_OR_HOLD = 303;
  public static final int METHOD_FLIC2_BUTTON_SINGLE_OR_DOUBLE_CLICK = 304;
  ...
  private final Flic2Controller.ButtonCallback flic2Callback = new Flic2Controller.ButtonCallback() {
    ...
    public void onButtonSingleOrDoubleClickOrHold(Flic2Button button, boolean wasQueued, boolean lastQueued,
      ...
      final String jsonData = jsonOnButtonSingleOrDoubleClickOrHold(button, wasQueued, lastQueued, timestamp,
          isSingleClick, isDoubleClick,
          isHold);
      informListeners(METHOD_FLIC2_BUTTON_CLICK_SINGLE_OR_DOUBLE_CLICK_OR_HOLD, jsonData);
    }
    ...
    public void onButtonUpOrDown(Flic2Button button, boolean wasQueued, boolean lastQueued, long timestamp,
      ...
      final String jsonData = jsonOnButtonUpOrDown(button, wasQueued, lastQueued, timestamp,
          isUp,
          isDown);
      informListeners(METHOD_FLIC2_BUTTON_UP_OR_DOWN, jsonData);
    }

    @Override
    public void onButtonClickOrHold(Flic2Button button, boolean wasQueued, boolean lastQueued, long timestamp,
        boolean isClick, boolean isHold) {
      final String jsonData = jsonOnButtonClickOrHold(button, wasQueued, lastQueued, timestamp,
          isClick,
          isHold);
      informListeners(METHOD_FLIC2_BUTTON_CLICK_OR_HOLD, jsonData);
    }

    @Override
    public void onButtonSingleOrDoubleClick(Flic2Button button, boolean wasQueued, boolean lastQueued, long timestamp,
        boolean isSingleClick, boolean isDoubleClick) {
      final String jsonData = jsonOnButtonSingleOrDoubleClick(button, wasQueued, lastQueued, timestamp, isSingleClick, isDoubleClick);
      informListeners(METHOD_FLIC2_BUTTON_SINGLE_OR_DOUBLE_CLICK, jsonData);
    }

    private String jsonOnButtonSingleOrDoubleClickOrHold(Flic2Button button, boolean wasQueued, boolean lastQueued,
        long timestamp,
        boolean isSingleClick, boolean isDoubleClick, boolean isHold) {
      final String jsonData = "{" +
          stringBaseButtonClickEvent(button, wasQueued, lastQueued, timestamp) + "," +
    ...
    private String jsonOnButtonUpOrDown(Flic2Button button, boolean wasQueued, boolean lastQueued, long timestamp,
        boolean isUp, boolean isDown) {
      final String jsonData = "{" +
          stringBaseButtonClickEvent(button, wasQueued, lastQueued, timestamp) + "," +
          "\"isUp\":" + isUp + "," +
    ...
    private String jsonOnButtonSingleOrDoubleClick(Flic2Button button, boolean wasQueued, boolean lastQueued, long timestamp,
        boolean isSingleClick, boolean isDoubleClick) {
      final String jsonData = "{" +
          stringBaseButtonClickEvent(button, wasQueued, lastQueued, timestamp) + "," +
          "\"isSingleClick\":" + isSingleClick + "," +
    ...
    private String jsonOnButtonClickOrHold(Flic2Button button, boolean wasQueued, boolean lastQueued, long timestamp,
        boolean isClick, boolean isHold) {
      final String jsonData = "{" +
          stringBaseButtonClickEvent(button, wasQueued, lastQueued, timestamp) + "," +
          "\"isClick\":" + isClick + "," +
    ...
    private String stringBaseButtonClickEvent(Flic2Button button, boolean wasQueued, boolean lastQueued,
        long timestamp) {
      return "\"wasQueued\":" + wasQueued + "," +
